    ...
    <section>
      ...
      <div className='lg:flex gap-10 shadow-lg p-10 rounded-xl my-2 dark: shadow-slate-600'>
        <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-2 place-items-center'>
          <div>
            <img src={mongo} width={100} height={100} alt='schema' />
          ...
          <div>
            <img src={express} width={100} height={100} alt='schema' />
            <p className=' text-center text-md py-2 leading-8 text-gray-800 font-burtons dark:text-slate-400'>
              express
            </p>
          </div>
          <div>
            <img src={react} width={100} height={100} alt='schema' />
            <p className=' text-center text-md py-2 leading-8 text-gray-800 font-burtons dark:text-slate-400'>
              react
            </p>
          </div>
          <div>
            <img src={node} width={100} height={100} alt='schema' />
            <p className=' text-center text-md py-2 leading-8 text-gray-800 font-burtons dark:text-slate-400'>
              node.js
            </p>
          </div>
          <div>
            <img src={tailwind} width={100} height={100} alt='schema' />
            <p className=' text-center text-md py-2 leading-8 text-gray-800 font-burtons dark:text-slate-400'>
              tailwind
            </p>
          </div>
          <div>
            <img src={html} width={100} height={100} alt='schema' />
            <p className=' text-center text-md py-2 leading-8 text-gray-800 font-burtons dark:text-slate-400'>
              html
            </p>
          </div>
          <div>
            <img src={css} width={100} height={100} alt='schema' />
            <p className=' text-center text-md py-2 leading-8 text-gray-800 font-burtons dark:text-slate-400'>
              css
            </p>
          </div>
          <div>
            <img src={sass} width={100} height={100} alt='schema' />
            <p className=' text-center text-md py-2 leading-8 text-gray-800 font-burtons dark:text-slate-400'>
              sass
            </p>
          </div>
          <div>
            <img src={js} width={100} height={100} alt='schema' />
            <p className=' text-center text-md py-2 leading-8 text-gray-800 font-burtons dark:text-slate-400'>
              javascript
            </p>
          </div>
          <div>
            <img src={api} width={100} height={100} alt='schema' />
            <p className=' text-center text-md py-2 leading-8 text-gray-800 font-burtons dark:text-slate-400'>
              api rest
            </p>
          </div>
          <div>
            <img src={seo} width={100} height={100} alt='schema' />
            <p className=' text-center text-md py-2 leading-8 text-gray-800 font-burtons dark:text-slate-400'>
              référencement
            </p>
          </div>
      ...
      <div className='lg:flex gap-10 shadow-lg p-10 rounded-xl my-2 dark: shadow-slate-600'>
        <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-2 place-items-center'>
          <div>
            <img src={vite} width={100} height={100} alt='schema' />
            <p className=' text-center text-md py-2 leading-8 text-gray-800 font-burtons dark:text-slate-400'>
              vite
            </p>
          </div>
          ...
          <div>
            <img src={next} width={100} height={100} alt='schema' />
            <p className=' text-center text-md py-2 leading-8 text-gray-800 font-burtons dark:text-slate-400'>
              next
            </p>
          </div>
          <div>
            <img src={svelte} width={100} height={100} alt='schema' />
            <p className=' text-center text-md py-2 leading-8 text-gray-800 font-burtons dark:text-slate-400'>
              svelte
            </p>
          </div>
